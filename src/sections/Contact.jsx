...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "therealluisdem@gmail.com",
        href: "mailto:therealluisdem@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+234 811 333 1113",
        href: "tel:+2348113331113",
    },
    {
        icon: MapPin,
        label: "Location",
    ...
    return <section id="contact" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center mx-auto max-w-3xl mb-16">
                ...
                <h2 className="text-4xl md:text-4xl font-bold mt-4 mb-6 animation-delay-100 text-secondary-foreground">Let's build
                    <span className="font-serif italic font-normal text-white"> {" "} something great.</span>
                </h2>
                <p className="text-muted-foreground animate-fade-in animation delay-200">
                    Have a project in mind? Get in touch with me to bring your ideas to reality.
                </p>
            </div>
